...
export const GetAQuote = () => {
	...
	return <GetAQuoteContainer>
		<GetAQuoteImageContainer/>
		<SectionTitle>GET A QUOTE</SectionTitle>
		<SectionComment>
			Interested in using our services? Simply fill out the form below and a member of our team will get in touch
			as soon as possible.
		</SectionComment>
		<GetAQuoteForm>
